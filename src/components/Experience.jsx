...
export default function Experience(){    
    const transition = {
      ...
      return (
        <section id="experience" className="grid grid-cols-2 p-5">
           
            <div>
             <h1 className="text-3xl text-center uppercase text-black p-4">Some technologies and tools I worked with</h1>  
             <div className="grid sm:grid-cols-2 md:grid-cols-6 items-center">          
        ...
        <div >
            <h1 className="text-center text-3xl text-black p-4 uppercase">where i've worked</h1>
